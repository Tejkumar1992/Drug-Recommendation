...
public class OwlMovie {
    ...
    public OwlMovie() {
        try {
            pm = new DefaultPrefixManager(null, null, "https://www.kdm.com/OWL/drugs#");
    ...
    public OWLOntology initialzation() throws Exception {
        ...
        ont = manager.createOntology(IRI.create("https://www.kdm.com/OWL/", "drugs"));
    ...
    public void saveOntology() {
        try {
            ...
            OutputStream os = new FileOutputStream("data/drugRecommendation.owl");
